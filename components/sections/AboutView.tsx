    ...
    <div className="mx-auto max-w-6xl px-4 py-12 md:px-6 md:py-16">
      ...
      >
        <div className="relative mx-auto w-full max-w-xs lg:mx-0">
          ...
          >
            <Download
              className="h-4 w-4 transition duration-300 group-hover/dl:-translate-y-0.5 group-hover/dl:translate-x-0.5 rtl:-scale-x-100 motion-reduce:transition-none"
              aria-hidden
            />
            {t("download_cv")}
          </MotionLink>
        ...
        <div>
          ...
          <section className="mt-10">
            ...
            <div className="mt-4 rounded-3xl flex flex-col md:flex-row justify-between card-surface p-6">
              <div>
              <div className="flex items-start gap-4">
                <div className="relative size-16 p-2 shrink-0 overflow-hidden rounded-2xl bg-[var(--bg-secondary)]">
                  <Image
                    src={edu.logo}
                    alt=""
                    fill
              ...
              <ul
                className={[
                  "mt-4 space-y-2 text-sm text-[var(--text-secondary)] list-disc ps-6",
                ].join(" ")}
              >
                {achievements.map((a) => (
                  <li key={a}>{a}</li>
