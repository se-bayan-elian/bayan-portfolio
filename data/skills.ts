...
export const skills: Skill[] = [
  ...
  { name: "REST APIs", level: 92, category: "backend", yearsOfExperience: 3, featured: false },
  ...
  { name: "PostgreSQL", level: 95, category: "database", yearsOfExperience: 2, featured: false },
  { name: "MongoDB", level: 90, category: "database", yearsOfExperience: 3, featured: false },
  { name: "Redis", level: 80, category: "database", yearsOfExperience: 1, featured: false },
  { name: "Prisma / TypeORM", level: 80, category: "database", yearsOfExperience: 2, featured: false },
  { name: "GitHub Actions", level: 90, category: "devops", yearsOfExperience: 2, featured: false },
  { name: "Docker", level: 80, category: "devops", yearsOfExperience: 1, featured: false },
  { name: "Nginx", level: 90, category: "devops", yearsOfExperience: 1, featured: false },
